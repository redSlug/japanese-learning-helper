...
function App() {
  const [count, setCount] = useState(0)
    ...
    const sampleCards: FlashCard[] = [
        ...
        { front: "TypeScript", back: "Typed superset of JavaScript that compiles to plain JavaScript" },
        { front: "JSX", back: "Syntax extension for JavaScript that looks like HTML" }
    ];
